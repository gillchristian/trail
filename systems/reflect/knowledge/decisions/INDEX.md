...
The scope decision itself (once made); choosing inputs/surface; interpreting an ambiguous requirement;
anything a teammate should understand later without asking.
