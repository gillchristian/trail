...
8. **Surface, don't swallow.** If I genuinely cannot proceed, I log a blocker in `progress/blockers.md` with everything the user needs to unblock me, then pick a different task. I do not invent answers to fundamental questions.
